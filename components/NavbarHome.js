            ...
            <div
              ...
              <ul className="flex flex-col align-center justify-center lg:flex-row list-none lg:ml-auto h-5/6 md:h-auto py-12">
                <li>
                  ...
                  <Link offset={() => 150} href="/#about" className="text-white hover:bg-orange px-4 py-2 transition-all duration-500">About</Link>
                  </a>
                </li>
                <li>
                  ...
                  <Link offset={() => 150} href="#projects" className="text-white hover:bg-orange px-4 py-2 transition-all duration-500">Projects</Link>
                  </a>
                </li>
                <li>
                  <a className="px-3 py-2 flex items-center justify-center text-2xl md:text-xs uppercase leading-snug text-white hover:text-orange hover:transition hover:duration-500 hover:ease-in-out" onClick={() => setTimeout(() => {setExpanded(false)}, 150)}>
                  <Link offset={() => 150} href="#contact" className="text-white hover:bg-orange px-4 py-2 transition-all duration-500">Contact</Link>
                  </a>
                </li>
              </ul>
            </div>
