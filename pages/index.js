        ...
        <div className="bg-hero-bg bg-cover bg-top mb-12">
          <div className="bg-black bg-opacity-30">
            <div className="container mx-auto">  
                <div className="w-full h-screen flex flex-col justify-center items-center px-6 text-white text-center drop-shadow-2xl">
                    ...
                    <Link href="/contact">
                      <button className="bg-orange hover:bg-gray-800 shadow-lg transition-all duration-500 text-white py-4 w-full md:w-96 px-12 md:px-24">Contact us Today</button>
                    </Link>
                </div>
            </div>
          </div>
          ...
          <Container>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-12 text-center lg:w-3/4 mx-auto">
                ...
                <div className="flex flex-col justify-between p-4 md:p-12 bg-gray-800 text-white shadow-lg">
