    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="Yvir0GKjx0rVsV35Egkg5uwi-qAJ50OVshax8DsVdrg"
        />
        <meta
          name="description"
          ...
          <div className="bg-black bg-opacity-30">
            <div className="container mx-auto">
              <div className="w-full h-screen flex flex-col justify-center items-center px-6 text-white text-center drop-shadow-2xl">
                <h1 className="font-bold leading-snug text-4xl md:text-5xl lg:text-7xl my-4 md:w-3/4 tracking-tight">
                  {page.heroTitle}
                </h1>
      ...
      <Container>
        ...
        <div className="text-center md:mt-48">
          <h2 className="text-6xl font-bold tracking-tighter leading-tight md:leading-none md:pb-4 text-black">
            Our Services
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 my-12 text-center  mx-auto">
          <div className="flex flex-col justify-between p-4 md:p-12 bg-gray-800 text-white shadow-lg rounded-lg">
            ...
            <h2 className="text-6xl md:text-4xl font-bold tracking-tighter leading-tight md:leading-none">
              {page.cardTitle2}
            </h2>
            <div
              dangerouslySetInnerHTML={{ __html: page.cardContent2.html }}
              className="py-4"
            />
            <Link href="/services#bathrooms">
              <button className="bg-orange hover:bg-white hover:text-black transition-all duration-500 py-4 w-full md:w-56 mx-auto mt-12 md:mt-4 rounded-lg">
                Find out More
              </button>
            </Link>
          </div>
          <div className="flex flex-col justify-between p-4 md:p-12 bg-gray-800 text-white shadow-lg rounded-lg">
            <MdKitchen
              size="3rem"
              className="mx-auto mb-4 md:mb-8 text-orange"
            />
            <h2 className="text-6xl md:text-4xl font-bold tracking-tighter leading-tight md:leading-none">
              {page.cardTitle3}
            </h2>
            <div
              dangerouslySetInnerHTML={{ __html: page.cardContent3.html }}
              className="py-4"
            />
