      ...
      <Container>
        <div className="pt-8 md:pt-8 lg:pt-16">
          <div className="text-center">
            <h2 className="text-6xl font-bold tracking-tighter leading-tight md:leading-none text-gray-800">Our Services</h2>
          </div>
      ...
      <div className="mt-12 md:my-24 lg:my-80">
        <div className="background-right">
          <div className="grid grid-cols-1 md:grid-cols-2 my-12 md:mt-56">
            ...
            <Link href="/projects">
              <button className="bg-orange hover:bg-gray-800 text-white hover:text-white transition-all duration-500 py-4 mt-12 w-full md:w-56 rounded-lg order-3 md:order-2 block md:hidden">View our Projects</button>
            </Link>
